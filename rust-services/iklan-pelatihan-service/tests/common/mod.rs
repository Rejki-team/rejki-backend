...
pub use fixtures::{clean_test_data, seed_admin, seed_iklan_pelatihan, seed_user};

/// Test app — build router untuk iklan-pelatihan-service saja dengan pool test.
/// Router ditempatkan di bawah `/api/v1/pelatihan` agar path cocok dengan main.rs.
