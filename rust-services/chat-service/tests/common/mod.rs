...
pub use fixtures::{clean_test_data, seed_user, TestUser};

/// Test app — build router untuk chat-service saja dengan pool test.
/// Router ditempatkan di bawah `/api/v1/chat`.
